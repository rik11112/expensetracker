...
export default function displayPayments() {
    ...
    const selectMonths = (
        <select
            ...
            onChange={(e) => changeMonths(parseInt(e.target.value))}
        >
        ...
        <Modal title={'Delete Payment'} showModal={deleteModalPaymentId != 0} setShowModal={closeDeleteModal}>
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="flex justify-center items-center mt-5">
                    <button className="bg-green-500 text-white rounded-md p-1 mx-3" onClick={confirmDelete}>
                        Confirm
                    </button>
                    <button className="bg-red-500 text-white rounded-md p-1 mx-3" onClick={closeDeleteModal}>
                        Cancel
                    </button>
                </div>
            </div>
        ...
        return (
            ...
            >
                <div className="flex items-center justify-between">
                    <span className={`${color} multi-shadow-text`}>
                        {sign}
                        {payment.amount / 100}
                    </span>
